                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if (frameCount % 20 === 0) {
                  ...
                  if (player.index !== null) {
                    if (fruit1Group.isTouching(players)){
                        fruit1Group.destroyEach();
                    }
                    if (fruit2Group.isTouching(players)){
                        fruit2Group.destroyEach();
                    }
                    if (fruit3Group.isTouching(players)){
                        fruit3Group.destroyEach();
                    }
                    if (fruit4Group.isTouching(players)){
                        fruit4Group.destroyEach();
                    }
                    if (fruit5Group.isTouching(players)){
                    ...
                    //all fruits on screen are being destroyed, not each individual fruit  
                     ...
                     if (fruit1Group.isTouching(player1)&&player.index!==0){
                         ps1+=1;
                        player.updateS1(ps1);
                     }
                     ...
                     if (fruit2Group.isTouching(player1)&&player.index!==0){
                        ps1+=1;
                       player.updateS1(ps1);
                    }
                    ...
                    if (fruit3Group.isTouching(player1)&&player.index!==0){
                        ps1+=1;
                       player.updateS1(ps1);
                    }
                    ...
                    if (fruit4Group.isTouching(player1)&&player.index!==0){
                        ps1+=1;
                       player.updateS1(ps1);
                    }
                    ...
                    if (fruit5Group.isTouching(player1)&&player.index!==0){
                        ps1+=1;
                       player.updateS1(ps1);
                    }
